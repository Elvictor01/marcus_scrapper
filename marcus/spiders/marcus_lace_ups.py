...
class MarcusShoeSpider(scrapy.Spider):
    name = 'marcus_lace_ups'
    page_number = 2

    start_urls = [
        'https://www.neimanmarcus.com/c/mens-shoes-lace-ups-cat10650732?navpath=cat000000_cat000470_cat000550_cat10650732&source=leftNav'
    ]
    ...
    def parse(self, response):
        ...
        next_page = 'https://www.neimanmarcus.com/c/mens-shoes-lace-ups-cat10650732?navpath=cat000000_cat000470_cat000550_cat10650732&page=' + \
